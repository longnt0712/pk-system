...
(function () {
    ...
    // Core.directive('ngSpinnerBar', ['$rootScope',
    //     function ($rootScope) {
    //         return {
    ...
    Core.directive('ngSpinnerBar', ['$rootScope', '$state',
    ...
    Core.directive('dropdownMenuHover', function () {
        return {
    ...
    Core.directive('select', function () {
        return {
            restrict: 'E',
            link: function (scope, elem, attrs) {
     ...
     */
    Core.directive('uiSelectRequired', function () {
        return {
            require: 'ngModel',
     ...
     * Tab component
     */
    Core.directive('tabdrop', [function () {
        return {
            restrict: 'A',
            link: function (scope, elem, attrs) {
     ...
     * Modal draggable
     */
    Core.directive('modalMovable', ['$document',
        function ($document) {
            return {
                restrict: 'AC',
                link: function (scope, elem, attrs) {
     ...
     */
    Core.directive('includeReplace', function () {
        return {
            require: 'ngInclude',
            restrict: 'A',
     ...
     * Toggle details
     */
    Core.directive('toggleView', function () {
        return {
            restrict: 'A',
            link: function ($scope, $elem, $attrs) {
     ...
     * On key press
     */
    Core.directive('onKeyPress', [function () {
        return {
            restrict: 'A',
            link: function ($scope, $element, $attrs) {
     ...
     */
    Core.directive('loginScreen', [function () {
        return {
            restrict: 'AC',
            link: function (scope, elem, attrs) {
                var $body = $('body');
     ...
     */
    Core.directive('adminScreen', [function () {
        return {
            restrict: 'AC',
            link: function (scope, elem, attrs) {
                var $body = $('body');
    ...
    Core.directive('slimScroll', [function () {
        return {
            restrict: 'A',
            link: function (scope, elem, attrs) {
    ...
    Core.directive('webuiPopover', ['$timeout', function ($timeout) {
        return {
            restrict: 'A',
            link: function (scope, elem, attrs) {
                var url = attrs.url || '#';
    ...
    Core.directive('dlEnterKey', function() {
