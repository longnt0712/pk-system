...
(function () {
    ...
    angular.module('Hrm.Body').service('BodyService', BodyService);
    ...
    function BodyService($http, $q, $filter, settings, utils) {
        var self = this;
        ...
        self.saveListObject = saveListObject;
        ...
        function saveListObject(object, successCallback, errorCallback) {
