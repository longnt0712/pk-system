        ...
        function translateContentType(contentType) {
            ...
            if (contentType.indexOf('image/') == 0) {
                ...
                if (sub.indexOf('msword') == 0
                    ...
                    || sub.indexOf('vnd.openxmlformats-officedocument.wordprocessingml.template') == 0
                    || sub.indexOf('vnd.openxmlformats-officedocument.spreadsheetml.sheet') == 0
                    || sub.indexOf('vnd.openxmlformats-officedocument.spreadsheetml.template') == 0
                    || sub.indexOf('vnd.openxmlformats-officedocument.presentationml.presentation') == 0
                    || sub.indexOf('vnd.openxmlformats-officedocument.presentationml.template') == 0
                    || sub.indexOf('vnd.openxmlformats-officedocument.presentationml.slideshow') == 0
