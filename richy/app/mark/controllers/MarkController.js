...
(function () {
    ...
    angular.module('Hrm.Mark').controller('MarkController', MarkController);

    MarkController.$inject = [
        '$rootScope',
        '$scope',
        'toastr',
        '$timeout',
    ...
    angular.module('Hrm.Mark').directive('fileDownload',function(){
        return{
            restrict:'A',
            scope:{
                fileDownload:'=',
    ...
    angular.module('Hrm.Mark').filter('removeHTMLTags', function() {
    ...
    function MarkController($rootScope, $scope, toastr, $timeout, settings, utils, modal, service, Upload) {
            ...
            options: {
                ...
                onCheck: function (row, $element) {
                    $scope.$apply(function () {
                        vm.selectedMarks.push(row);
                    });
                },
                onCheckAll: function (rows) {
                    $scope.$apply(function () {
                        vm.selectedMarks = rows;
                    });
                },
                onUncheck: function (row, $element) {
                    ...
                    if (index >= 0) {
                        $scope.$apply(function () {
                            vm.selectedMarks.splice(index, 1);
                        });
                    }
                },
