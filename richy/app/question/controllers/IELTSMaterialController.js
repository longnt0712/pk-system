...
(function () {
    ...
    angular.module('Hrm.Question').controller('IELTSMaterialController', IELTSMaterialController);

    IELTSMaterialController.$inject = [
        '$rootScope',
        '$scope',
        'toastr',
        '$timeout',
    ...
    function IELTSMaterialController($rootScope, $scope, toastr, $timeout, settings, utils, modal, service, $location,$stateParams,$window,blockUI,$sce,$cookies,topicService) {
        ...
        // vm.searchDto.questionType = {};
        // vm.searchDto.questionType.id = 21;
