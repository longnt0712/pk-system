...
(function () {
    ...
    function ViewController($rootScope, $scope, toastr, $timeout, settings, utils, modal, service, $location,$stateParams,$window,blockUI,$sce,$cookies,topicService) {
        ...
        function processTextByMode(text) {
            var oldExactAnswer = vm.exactAnswer;
        ...
        vm.fillingGaps = function (maxIndex, index, motherTongue) {
            ...
            var a = processTextByMode(vm.currentCard.motherTongue);
            var b = processTextByMode(vm.currentCard.fillingGapsAnswer);
        ...
        function processFillingGapsByMode(text, forceShowAnswer, shouldRegenerate) {
            ...
            function canTake(start, len, used) {
                if (start < 0 || start + len > words.length) return false;
