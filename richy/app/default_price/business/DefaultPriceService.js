...
(function () {
    ...
    angular.module('Hrm.DefaultPrice').service('DefaultPriceService', DefaultPriceService);

    DefaultPriceService.$inject = [
        '$http',
        '$q',
        '$filter',
        'settings',
    ...
    function DefaultPriceService($http, $q, $filter, settings, utils) {
        var self = this;
