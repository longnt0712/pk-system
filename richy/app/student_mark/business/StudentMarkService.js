...
(function () {
    ...
    angular.module('Hrm.StudentMark').service('StudentMarkService', StudentMarkService);

    StudentMarkService.$inject = [
        '$http',
        '$q',
        '$filter',
        'settings',
    ...
    function StudentMarkService($http, $q, $filter, settings, utils) {
        var self = this;
