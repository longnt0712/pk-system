    ...
    function UserService($http, $q, settings, utils) {
        ...
        function getTableDefinition() {
            ...
            var _tableOperation = function (value, row, index) {
                var ret = '<a class="btn btn-brown" href="#" data-ng-click="$parent.editUser(' + "'" + row.id + "'" + ')">sửa</a>';
...
//                }
                ret += '<a class="btn btn-brown" href="#" data-ng-click="$parent.changeUserPassword(' + "'" + row.id + "'" + ')">đổi mật khẩu</a>';
                return ret;
            };
