...
(function () {
    ...
    angular.module('Hrm.Class').controller('ClassController', ClassController);
    ...
    angular.module('Hrm.Class').directive('fileDownload',function(){
        return{
            restrict:'A',
            scope:{
                fileDownload:'=',
    ...
    angular.module('Hrm.Class').filter('removeHTMLTags', function() {
    ...
    function ClassController($rootScope, $scope, toastr, $timeout, settings, utils, modal, service, Upload) {
        ...
        vm.getPage = function () {
            service.getPage(vm.searchDto,vm.pageIndex, vm.pageSize).then(function (data) {
                vm.classes = data.content;
                vm.bsTableControl.options.data = vm.classes;
        ...
        vm.searchEduDto = {};
        vm.getPageEducationProgram = function () {
            service.getPageEducationProgram(vm.searchEduDto,1, 100000).then(function (data) {
                vm.educationPrograms = data.content;
            });
        };
        vm.getPageEducationProgram();
            ...
            options: {
                ...
                onCheck: function (row, $element) {
                    $scope.$apply(function () {
                        vm.selectedClasses.push(row);
                    });
                },
                onCheckAll: function (rows) {
                    $scope.$apply(function () {
                        vm.selectedClasses = rows;
                    });
                },
        ...
        vm.saveObject = function () {
            // service.saveObject(vm.class, function success(response) {
            //
            //     vm.getPage();
            ...
            service.saveObject(vm.class).then(function (data) {
                vm.getPage();
        ...
        vm.newObject = function () {
            ...
            modalInstance.result.then(function (confirm) {
                // if (confirm == 'yes') {
                //     // service.saveObject(vm.class, function success() {
                //     //     vm.getPage();
                //     //     toastr.info('Bạn đã tạo mới thành công một tài khoản.', 'Thông báo');
                //     //     vm.class = {};
                //     // }, function failure() {
        ...
        $scope.deleteObject = function (id) {
            ...
            modalInstance.result.then(function (confirm) {
                if (confirm == 'yes') {
                	console.log(vm.selectedClasses);
