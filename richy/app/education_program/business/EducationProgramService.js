...
(function () {
    ...
    angular.module('Hrm.EducationProgram').service('EducationProgramService', EducationProgramService);

    EducationProgramService.$inject = [
        '$http',
        '$q',
        '$filter',
        'settings',
    ...
    function EducationProgramService($http, $q, $filter, settings, utils) {
        var self = this;
