...
(function () {
    ...
    angular.module('Hrm.TopicCategory').service('TopicCategoryService', TopicCategoryService);

    TopicCategoryService.$inject = [
        '$http',
        '$q',
        '$filter',
        'settings',
    ...
    function TopicCategoryService($http, $q, $filter, settings, utils) {
        var self = this;
