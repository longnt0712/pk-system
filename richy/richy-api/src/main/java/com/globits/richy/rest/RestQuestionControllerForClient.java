...
public class RestQuestionControllerForClient {
	@Autowired
...
//	@Secured({"ROLE_ADMIN","ROLE_USER"})
	...
	@RequestMapping(value = "/get_page_reverse/{pageIndex}/{pageSize}", method = RequestMethod.POST)
	public Page<QuestionDto> getPageReverse(@RequestBody QuestionDto searchDto, @PathVariable int pageIndex,@PathVariable int pageSize) {
		return service.getPageObjectReverse(searchDto, pageIndex, pageSize);
	}
//	@Secured({"ROLE_ADMIN","ROLE_USER"})
