...
public class RestAnswerController {
	...
	public Page<AnswerDto> getPage(@RequestBody AnswerDto searchDto, @PathVariable int pageIndex,@PathVariable int pageSize) {
	...
	public boolean saveOne(@RequestBody AnswerDto searchDto) {
