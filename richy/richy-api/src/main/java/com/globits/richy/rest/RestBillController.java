...
public class RestBillController {
	...
	@Secured({"ROLE_ADMIN","ROLE_STAFF_MANAGEMENT","ROLE_STAFF"})
	@RequestMapping(value = "/get_page_statistics", method = RequestMethod.POST)
	public BillStatisticsDto getBillStatistics(@RequestBody BillDto searchDto) {
		return service.getBillStatistics(searchDto);
	}
	...
	@RequestMapping(value = "/save_bill_for_manager", method = RequestMethod.POST)
	public boolean saveBillForManager(@RequestBody BillDto searchDto) {
		return service.saveObject(searchDto);
	}
