...
public class RestQuestionController {
    ...
    public Page<QuestionDto> getPage(
    ...
    public Page<QuestionForGamesDto> getPageForGames(
            @RequestBody QuestionDto searchDto,
            @PathVariable int pageIndex,
            @PathVariable int pageSize) {
    ...
    public Page<QuestionUserDto> getStatisticQuestionUser(
            @RequestBody QuestionDto searchDto,
            @PathVariable int pageIndex,
            @PathVariable int pageSize) {
    ...
    public Page<QuestionOnlyQuestionDto> getPageOnlyQuestion(
            @RequestBody QuestionDto searchDto,
            @PathVariable int pageIndex,
            @PathVariable int pageSize) {
    ...
    public ResponseEntity<?> previewExcelImport(
        ...
        try {
            QuestionImportPreviewDto result =
                    questionExcelImportService.preview(file, topicId);
