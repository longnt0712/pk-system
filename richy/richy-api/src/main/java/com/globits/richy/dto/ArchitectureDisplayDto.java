...
public class ArchitectureDisplayDto implements Serializable{
	private Long id;
	private String name;
	private String url;
//	private String code;
...
//	}
	...
	public ArchitectureDisplayDto() {
		
	}
	public ArchitectureDisplayDto(Shoes domain) {
...
//			int i = 0;
			for (ShoesImageUrls item : domain.getShoesImageUrls()) {
				if(item.getOrdinalNumber() != null && item.getOrdinalNumber() == 1) {
